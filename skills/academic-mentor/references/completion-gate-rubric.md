...
Use this rubric when `academic-mentor` judges whether copilot should stop or continue.
...
Do not directly perform the revision unless the user explicitly asks mentor to switch from gatekeeper to executor.
