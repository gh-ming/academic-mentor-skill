...
我们十分尊重这些杰出的学者，因此不会把他们简化成廉价的角色扮演。但我们也不希望导师变成没有人的味道的“审稿器”。这个项目学习的是他们在公开论文、课程、访谈和项目中体现出的研究判断方式，也尽量保留其稳定的表达风格、提问方式和沟通节奏：如何选择重要问题，如何控制贡献边界，如何组织证据，如何把批评变成真正可执行的指导。
...
这部分机制借鉴了 [nuwa-skill](https://github.com/alchaincyf/nuwa-skill) 在“多源蒸馏人物 skill”上的方法优势。我们也认同：一个好的人物 skill 不只是规则集合，还应保留其可验证的语言风格与思维表达。只是放到学术场景里，我们会把重点放在研究判断、论文表达、实验证据和导师式指导上，而不是只做表层人格模仿。
